...
namespace TSICS.Controllers.Dashboard
{
    ...
    {
        // GET: TableRelatedTROverview
        public Tuple<List<TicketAPIDashboardOverview>, int> getListTableRelatedTROverview(FormCollection collection, String Hid, String Rental, String Others, string paramsModel, string paramsSerialNumber, bool btnPOST = false)
        {
            ...
            string[] dataFiltered = getListSerialNumberFiltered(Convert.ToInt32(collection["filterType"]), SplitArea, SplitSalesOffice, SplitCustomer, SplitFamily, SplitIndustry, SplitModel, SplitSerialNumber, repairdatefrom, repairdateto, purchasedatefrom, purchasedateto, deliverydatefrom, deliverydateto, collection["SMURangeFrom"], collection["SMURangeTo"], SplitProduct, SplitPlant, Hid , RentalVal, Others, paramsModel, paramsSerialNumber, btnPOST);
            var getData = _TicketBs.getListTicketBySerialNumber(dataFiltered);
            return Tuple.Create(getData.Item1, getData.Item2);
        }

        public Tuple< List<TicketAPIDashboardOverview>, int> getListTableRelatedTROverviewGet(GetFormCollectionOverview collection, String Hid, String Rental, String Others, string paramsModel, string paramsSerialNumber, bool btnPOST=false)
        {
            ...
            if (!String.IsNullOrWhiteSpace(Rental))
            {
                RentalVal = Rental.Replace("?model=1", "");
            }
